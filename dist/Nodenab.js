...
'use strict';function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}var BaseSerializable = require('./BaseSerializable');

module.exports = function (_BaseSerializable) {_inherits(HeaderArquivo, _BaseSerializable);function HeaderArquivo() {_classCallCheck(this, HeaderArquivo);return _possibleConstructorReturn(this, (HeaderArquivo.__proto__ || Object.getPrototypeOf(HeaderArquivo)).apply(this, arguments));}return HeaderArquivo;}(BaseSerializable);
'use strict';function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}var BaseSerializable = require('./BaseSerializable');

module.exports = function (_BaseSerializable) {_inherits(HeaderLote, _BaseSerializable);function HeaderLote() {_classCallCheck(this, HeaderLote);return _possibleConstructorReturn(this, (HeaderLote.__proto__ || Object.getPrototypeOf(HeaderLote)).apply(this, arguments));}return HeaderLote;}(BaseSerializable);
...
module.exports = function (_BaseSerializable) {_inherits(TrailerArquivo, _BaseSerializable);function TrailerArquivo() {_classCallCheck(this, TrailerArquivo);return _possibleConstructorReturn(this, (TrailerArquivo.__proto__ || Object.getPrototypeOf(TrailerArquivo)).apply(this, arguments));}return TrailerArquivo;}(BaseSerializable);
'use strict';function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}var BaseSerializable = require('./BaseSerializable');

module.exports = function (_BaseSerializable) {_inherits(TrailerLote, _BaseSerializable);function TrailerLote() {_classCallCheck(this, TrailerLote);return _possibleConstructorReturn(this, (TrailerLote.__proto__ || Object.getPrototypeOf(TrailerLote)).apply(this, arguments));}return TrailerLote;}(BaseSerializable);
'use strict';var Layout = require('./Parser/Layout');
var Remessa = require('./Model/Remessa');
var RemessaFile = require('./Output/RemessaFile');
var RetornoFile = require('./Input/RetornoFile');

module.exports = {
    Layout: Layout,
    Remessa: Remessa,
    RemessaFile: RemessaFile,
    RetornoFile: RetornoFile };
